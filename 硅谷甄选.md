...
在Vue3中可以利用useAttrs方法获取组件的属性与事件(包含:原生DOM事件或者自定义事件),次函数功能类似于Vue2框架中![img](https://cdn.nlark.com/yuque/__latex/7ac2d7c9d690f0f79f33ba6e4a94222f.svg)listeners方法。
...
但是你会发现在src/styles/index.scss全局样式文件中没有办法使用![img](https://cdn.nlark.com/yuque/__latex/9202b9a8d9ab539f0ce736a5e6c834d3.svg).
